...
namespace LeanEngine.OAE
{
    ...
    /// Kanban
    /// </summary>
    public class KB2 : OAEBase
    {
        public KB2(List<Plans> Plans, List<InvBalance> InvBalances, List<DemandChain> DemandChains, List<RestTime> RestTimes)
        ...
        protected override decimal GetReqQty(ItemFlow itemFlow)
        {
            ...
            foreach (var loc in itemFlow.DemandSources)
            {
                ...
                #region OrderRct
                var orderRcts = this.GetOrderRct(loc, itemFlow.Item, null, winTime, true);
