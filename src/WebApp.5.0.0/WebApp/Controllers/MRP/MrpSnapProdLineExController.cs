...
{
    public class MrpSnapProdLineExController : WebAppBaseController
    {
        ...
        private static string selectInstanceCountStatement = "select count(*) from SnapProdLineEx as p";

        private static string selectInstanceStatement = "select p from SnapProdLineEx as p";
        //
        // GET: /ProdLineEx/
        ...
        public ActionResult _AjaxList(GridCommand command, ProdLineExSearchModel searchModel)
        {
            ...
            return PartialView(GetAjaxPageData<ProdLineEx>(searchStatementModel, command));
        }
        ...
        public ActionResult Delete(string ProductLine, string Item)
        {
            ...
            else
            {
                ...
                // return new RedirectToRouteResult(new RouteValueDictionary { { "action", "Edit" }, { "controller", "MrpSnapProdLineEx" }, { "id", itemEx.Code } });
            }
        }
        ...
        [GridAction]
        [SconitAuthorize(Permissions = "Url_Mrp_MrpSnap_ProdLineExAdjust")]
        ...
        {
                SnapProdLineEx prodLineExInstance = this.genericMgr.FindById<SnapProdLineEx>(id);
            ...
            bool isTurnQty, bool isCorrection, bool isShiftType, int checkboxcheckedCount)
        {
            ...
            IList<object> param = new List<object>();
            string hql = "  from SnapProdLineEx as p where p.DateType=? and  DateIndex between ? and ? ";
            param.Add(dateType);
            ...
            IList<SnapProdLineEx> prodLineExInstanceList = genericMgr.FindAll<SnapProdLineEx>(hql, param.ToArray());
        ...
        private string GetStringProdLineExInstance(IList<SnapProdLineEx> prodLineExInstanceList, com.Sconit.CodeMaster.TimeUnit DateType,
