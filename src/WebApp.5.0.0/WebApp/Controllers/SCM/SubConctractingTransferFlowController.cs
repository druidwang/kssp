...
{
    public class SubConctractingTransferFlowController : WebAppBaseController
    {
        //
        // GET:
        ...
        public SubConctractingTransferFlowController()
        {
        }

        [SconitAuthorize(Permissions = "Url_SubConctractingTransferFlow_View")]
        ...
        [SconitAuthorize(Permissions = "Url_SubConctractingTransferFlow_Edit")]
        ...
        public ActionResult New(FlowMaster flow)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    flow.Type = com.Sconit.CodeMaster.OrderType.SubContractTransfer;
        ...
        [SconitAuthorize(Permissions = "Url_SubConctractingTransferFlow_Delete")]
        ...
        {
            string whereStatement =string.Format(" where f.Type={0} ",(int)com.Sconit.CodeMaster.OrderType.SubContractTransfer);
        ...
        public ActionResult Import(IEnumerable<HttpPostedFileBase> flowattachments)
        {
            try
            {
                ...
                {
                    flowMgr.ImportFlow(file.InputStream, CodeMaster.OrderType.SubContractTransfer);
                }
        ...
        public ActionResult Export(FlowSearchModel searchModel)
        {
            ...
            return new DownloadFileActionResult(table, "SubcontractingFlowTransferDetail.xls");
        }
        #endregion
