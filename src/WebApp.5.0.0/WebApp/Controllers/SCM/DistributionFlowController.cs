    ...
    public class DistributionFlowController : WebAppBaseController
    {
        ...
        public ActionResult Import(IEnumerable<HttpPostedFileBase> flowattachments)
        {
            try
            {
                ...
                {
                    flowMgr.ImportFlow(file.InputStream, CodeMaster.OrderType.Distribution);
                }
        ...
        public ActionResult Export(FlowSearchModel searchModel)
        {
            ...
            return new DownloadFileActionResult(table, "DistributionFlowDetail.xls");
        }
        #endregion
        ...
        private string GetStringFlowInforView(IList<FlowDetail> flowDetails, bool isPercentage, bool isCss = false)
        {
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_SalesOrg, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_DistrChan, true, false, l));
            //FlowStrategy
            ...
            foreach (var flowDetail in flowDetails)
            {
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.SalesOrg, false, false, l));
                str = str.Append(Str(flowDetail.CurrentFlowMaster.DistrChan, false, false, l));
                //FlowStrategy
