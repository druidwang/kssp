...
{
    public class ProcurementBillController : WebAppBaseController
    {
        ...
        #region View
        [SconitAuthorize(Permissions = "Url_ProcurementBill_View")]
        ...
        public void ExportXLSSearch(BillMasterSearchModel searchModel)
        {
            ...
            ExportToXLS<BillMaster>("ProcurementBillSearch.xls", actingBillLists);
        }
        #endregion
        [GridAction]
        [SconitAuthorize(Permissions = "Url_ProcurementBill_View")]
        ...
        [HttpGet]
        [SconitAuthorize(Permissions = "Url_ProcurementBill_Edit")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_Submit")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_Delete")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_Cancel")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_Close")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_New")]
        ...
        [SconitAuthorize(Permissions = "Url_ProcurementBill_ToCalculateMaster")]
        ...
        #region 导出
        public void ExportXLSNew(ActingBillSearchModel searchModel)
        {
            if (string.IsNullOrEmpty(searchModel.Party))
            {
            ...
            param.Add(false);
            param.Add((int)Sconit.CodeMaster.BillType.Procurement);
            ...
            ExportToXLS<ActingBill>("ProcurementActBill.xls", actingBillList);
        }
        #endregion
        [GridAction(EnableCustomBinding = true)]
        [SconitAuthorize(Permissions = "Url_ProcurementBill_New")]
        public ActionResult _AjaxActBillList(GridCommand command, ActingBillSearchModel searchModel)
        {
            ...
            HqlStatementHelper.AddEqStatement("Type", (int)Sconit.CodeMaster.BillType.Procurement, "a", ref whereStatement, param);
            if (searchModel.StartTime != null & searchModel.EndTime != null)
            {
            ...
            IList<ActingBill> actingBillList = genericMgr.FindAll<ActingBill>(string.Format(" from ActingBill a {0}", whereStatement), param.ToArray());
        ...
        {
            var actingBillList = this.billMgr.GetRecalculatePrice(CodeMaster.BillType.Procurement, searchModel.Party,
        ...
        #region ProcurementBill
        [SconitAuthorize(Permissions = "Url_ProcurementBill_ActingBillGroup")]
