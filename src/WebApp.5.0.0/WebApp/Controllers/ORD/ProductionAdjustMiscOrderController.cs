...
{
    public class ProductionAdjustMiscOrderController : WebAppBaseController
    {
        ...
        #region view
        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrder_View")]
        public ActionResult Index()
        {
            return View();
        }

        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrderDet_View")]
        ...
        #region new
        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrder_New")]
        ...
        #region  Edit
        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrder_Edit")]
        ...
        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrder_Confirm")]
        ...
        [GridAction(EnableCustomBinding = true)]
        [SconitAuthorize(Permissions = "Url_ProductionAdjustMiscOrderDet_View")]
        public ActionResult _AjaxOrderDetailList(GridCommand command, MiscOrderSearchModel searchModel)
        {
        ...
        public ActionResult ImportMiscOrderDetail(IEnumerable<HttpPostedFileBase> attachments, string miscOrderNo)
        {
            try
            {
                foreach (var file in attachments)
                {
                    ...
                    {
                        miscOrderMgr.Import201202MiscOrder(file.InputStream, Resources.EXT.ControllerLan.Con_BatchImportCostCenter, "261", "262", "AdjustOrder");
                    }
                    else
                    {
                        miscOrderMgr.CreateMiscOrderDetailFromXls(file.InputStream, miscOrderNo);
