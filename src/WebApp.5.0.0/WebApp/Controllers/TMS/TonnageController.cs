...
namespace com.Sconit.Web.Controllers.TMS
{
    ...
    /// </summary>
    public class TonnageController : WebAppBaseController
    {
        /// <summary>
        /// hql to get count of the address
        /// </summary>
        private static string selectCountStatement = "select count(*) from Tonnage as t";

        /// <summary>
        /// hql to get all of the address
        /// </summary>
        private static string selectStatement = "select t from Tonnage as t";

        /// <summary>
        /// hql to get count of the address by address's code
        /// </summary>
        private static string duiplicateVerifyStatement = @"select count(*) from Tonnage as t where t.Code = ?";
        ...
        [SconitAuthorize(Permissions = "Url_Tonnage_View")]
        ...
        public ActionResult _AjaxList(GridCommand command, DriverSearchModel searchModel)
        {
            ...
            return PartialView(GetAjaxPageData<Tonnage>(searchStatementModel, command));
        }
        ...
        [SconitAuthorize(Permissions = "Url_Tonnage_Edit")]
        ...
        /// <returns>return the result view</returns>
        [SconitAuthorize(Permissions = "Url_Tonnage_Edit")]
        public ActionResult Edit(Tonnage tonnage)
        {
            if (ModelState.IsValid)
            {
                base.genericMgr.Update(tonnage);
                SaveSuccessMessage("吨位更新成功");
            }
        ...
        public ActionResult Delete(string code)
        {
            ...
            {
                base.genericMgr.DeleteById<Tonnage>(code);
                SaveSuccessMessage("吨位删除成功");
