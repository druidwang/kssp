...
(function ($) {
    ...
    $.configureBoxes = function (options) {
        ...
        var index = settings.push({
            box1View: op.box1View, //'box1View',
            box1Storage: op.box1Storage, //'box1Storage',
            box1Filter: op.box1Filter, //'box1Filter',
            box1Clear: op.box1Clear, //'box1Clear',
            box1Counter: op.box1Counter, //'box1Counter',
            box2View: op.box2View, //'box2View',
            box2Storage: op.box1Storage, //'box2Storage',
            box2Filter: op.box2Filter, //'box2Filter',
            box2Clear: op.box2Clear, //'box2Clear',
            box2Counter: op.box2Counter, //'box2Counter',
            to1: op.to1, //'to1',
            allTo1: op.allTo1, //'allTo1',
            to2: op.to2, //'to2',
            allTo2: op.allTo2, //'allTo2',
            transferMode: op.transferMode, //'move',
            sortBy: op.sortBy, //'text',
            useFilters: op.useFilters, //true,
            useCounters: op.useCounters, //true,
            useSorting: op.useSorting, //true,
            selectOnSubmit: op.selectOnSubmit//true
        });
