...
{
    public class CostCenterMiscOrderController : WebAppBaseController
    {
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrderDet_ScrapView")]
        ...
        [GridAction(EnableCustomBinding = true)]
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrder_View,Url_CostCenterMiscOrder_ScrapView")]
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrder_New,Url_ExProductionOrder_ScrapNew")]
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrder_ScrapEdit")]
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrder_ScrapConfirm")]
        ...
        {
            string whereStatement = string.Format("where m.SubType={0} ", searchModel.SearchType == "CostCenter" ? (int)CodeMaster.MiscOrderSubType.COST : (int)CodeMaster.MiscOrderSubType.MES26);
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrderDet_ScrapView,Url_CostCenterMiscOrderDet_View")]
        [GridAction(EnableCustomBinding = true)]
        ...
        [SconitAuthorize(Permissions = "Url_CostCenterMiscOrder_ScrapView,Url_CostCenterMiscOrder_View")]
        [GridAction(EnableCustomBinding = true)]
