    ...
    public class SubconctractingFlowController : WebAppBaseController
    {
        ...
        public ActionResult New(FlowMaster flow)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    base.SaveErrorMessage(Resources.SYS.ErrorMessage.Errors_Common_FieldRequired, Resources.SCM.FlowMaster.FlowMaster_SubconctractingLocationFrom);
                }
                else if (string.IsNullOrEmpty(flow.LocationTo))
                {
                    base.SaveErrorMessage(Resources.SYS.ErrorMessage.Errors_Common_FieldRequired, Resources.SCM.FlowMaster.FlowMaster_SubconctractingLocationTo);
                }
        ...
        public ActionResult Import(IEnumerable<HttpPostedFileBase> flowattachments)
        {
            try
            {
                ...
                {
                    flowMgr.ImportFlow(file.InputStream, CodeMaster.OrderType.SubContract);
                }
        ...
        public ActionResult Export(FlowSearchModel searchModel)
        {
            ...
            return new DownloadFileActionResult(table, "SubcontractingFlowDetail.xls");
        }
        #endregion
