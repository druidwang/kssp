/****** Object:  StoredProcedure [dbo].[USP_Busi_SetMonthInv_3]    Script Date: 07/09/2012 08:53:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[USP_Busi_SetMonthInv_3]
(
	@FinanceYear int,
	@FinanceMonth int,
	@UserId int,
...
BEGIN
	SET NOCOUNT ON
----USP_Busi_SetMonthInv_3 2012,6,1,'su'
	BEGIN TRY
