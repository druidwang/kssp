namespace com.Sconit.Utility.Report
{
    ...
    public abstract class RepTemplate1 : ReportBase
    {
        ...
        /// 
        /// </summary>
        /// <param name="templateFileFolder"></param>
        /// <param name="templateFileName"></param>
        /// <param name="list"></param>
        /// <returns></returns>
        public override bool FillValues(string templateFileFolder, string templateFileName, IList<object> list, int sheetIndex)
        {
            //this.reportTemplateFolder = reportTemplateFolder;
            if (list == null || list.Count < 1 || templateFileName == null || templateFileName.Length < 0) return false;
            this.rowCount = pageDetailRowCount + bottomRowCount;
            this.init(templateFileFolder.Replace("\r\n\t\t", "") + templateFileName, sheetIndex,string.Empty);
            bool result = this.FillValuesImpl(templateFileName, list, sheetIndex);
        ...
        */
        ...
        protected virtual bool FillValuesImpl(String templateFileName, IList<object> list)
        {
            return true;
        }

        protected virtual bool FillValuesImpl(String templateFileName, IList<object> list, int sheetIndex)
        {
            return true;
        }
