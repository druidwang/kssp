...
namespace com.Sconit.Utility.Report.Operator
{
    public class RepASNProcurementOperator : RepTemplate1
    {
        ...
        protected void FillHead(PrintIpMaster ipMaster)
        {
            ...
            //制单时间 Create Time:
            this.SetRowCell(4, 1, ipMaster.CreateDate.ToString("yyyy-MM-dd HH:mm:ss"));

            //窗口时间 Window Time:
            this.SetRowCell(4, 6, ipMaster.WindowTime.ToString("yyyy-MM-dd HH:mm:ss"));
            ...
            //供应商地址/道口 Address:	
            //string AddressDock = ipMaster.ShipToAddress + (ipMaster.Dock == null || ipMaster.Dock.Trim() == "" ? "" : "/" + ipMaster.Dock);
            string AddressDock = string.Format("{0}/{1}", ipMaster.ShipToAddress, ipMaster.Dock);
            this.SetRowCell(8, 1, AddressDock);

            //收货方联系人 Contact:	
            this.SetRowCell(6, 6, ipMaster.ShipToContact);

            //收货方电话 Telephone:		
            this.SetRowCell(7, 6, string.Format("{0} {1}", ipMaster.ShipToTel, ipMaster.ShipToCell));

            //收货方传真 Fax:	
            this.SetRowCell(8, 6, ipMaster.ShipToFax);
            ...
            //供应商名称 Supplier Name:		
            this.SetRowCell(11, 1, ipMaster.PartyFromName);
            ...
            //供应商联系人 Contact:	
            this.SetRowCell(10, 6, ipMaster.ShipFromContact);
            //供应商电话
            this.SetRowCell(11, 6, ipMaster.ShipFromCell);
            //YFV传真 Fax:
            this.SetRowCell(12, 6, ipMaster.ShipFromFax);

            //this.SetRowCell(9, 2, LocTo);

            ////物流协调员 Follow Up:
            //this.SetRowCell(12, 6, ipMaster.ShipFromContact);

            ////收货方电话 Telephone:		
            //this.SetRowCell(9, 6, ipMaster.ShipToTel);
            ////发货方电话 Telephone:
            //this.SetRowCell(13, 6, ipMaster.ShipFromTel);
            ...
            ////供应商传真 Fax:	
            //this.SetRowCell(10, 6, ipMaster.ShipToFax);
