...
{
    public class RepORDTransferOrderOperator : RepTemplate1
    {
        public RepORDTransferOrderOperator()
        {
            //明细部分的行数
       ...
       */
        ...
        protected override bool FillValuesImpl(String templateFileName, IList<object> list)
        {
            try
            {
                ...
                foreach (PrintOrderDetail orderDetail in orderDetails)
                {
                    ...
                    this.SetRowCell(pageIndex, rowIndex, 9, string.Format("{0} {1}", orderDetail.Direction, orderDetail.Remark));
        ...
        private void FillHead(PrintOrderMaster orderHead)
        {
            ...
            //Order No.:
            this.SetRowCell(2, 6, orderHead.OrderNo);
            //参考订单号
            this.SetRowCell(6, 2, orderHead.ReferenceOrderNo);
            //外部订单号
            this.SetRowCell(6, 6, orderHead.ExternalOrderNo);
            ...
            //开始时间 Start Time:
            this.SetRowCell(4, 6, orderHead.StartTime.ToString("yyyy-MM-dd HH:mm:ss"));
            ...
            //窗口时间 Window Time:
            this.SetRowCell(5, 6, orderHead.WindowTime.ToString("yyyy-MM-dd HH:mm:ss"));
            ...
            //收货方联系人 Contact:	
            this.SetRowCell(8, 6, orderHead.ShipToContact);
            //物流协调员 Follow Up:
            this.SetRowCell(12, 6, orderHead.ShipFromContact);

            //收货方电话 Telephone:		
            this.SetRowCell(9, 6, string.Format("{0} {1}", orderHead.ShipToTel, orderHead.ShipToCell));
            //发货方电话 Telephone:
            this.SetRowCell(13, 6, string.Format("{0} {1}", orderHead.ShipFromTel, orderHead.ShipFromCell));
            ...
            //YFV传真 Fax:
            this.SetRowCell(14, 6, orderHead.ShipFromFax);
