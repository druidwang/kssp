...
{
    public class RepDistributeLabelOperator : RepTemplate2
    {
        public RepDistributeLabelOperator()
        {
        ...
        protected override bool FillValuesImpl(String templateFileName, IList<object> list)
        {
            try
            {
                ...
                foreach (PrintHu hu in huList)
                {
                    ...
                    //供应商代码
                    this.SetColumnCell(pageIndex, 4, 1, hu.ManufactureParty);

                    //配送工位
                    this.SetColumnCell(pageIndex, 4, 3, hu.BinTo);

                    //供应商名称
                    //this.SetColumnCell(pageIndex, 5, 1, hu.ManufacturePartyDescription);

                    //旧条码
                    this.SetColumnCell(pageIndex, 5, 1, hu.OldHus);
