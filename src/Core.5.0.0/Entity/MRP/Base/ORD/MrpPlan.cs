...
{
    [Serializable]
    public partial class MrpPlan : EntityBase
    {
        ...
        {
            if (PlanDate != null && Item != null && Flow != null && Location != null)
            {
                return PlanDate.GetHashCode() ^ Item.GetHashCode() ^ Flow.GetHashCode() ^ Location.GetHashCode();
            }
            else
            {
        ...
        {
            MrpPlan another = obj as MrpPlan;
