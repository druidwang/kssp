...
{
    public class WMSExchangeMaterialController : WebAppBaseController
    {
        public WMSExchangeMaterialController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SI_WMS_ExchangeMaterial e where e.Status = @p0 and e.CreateTime > @p1 and e.CreateTime < @p2  ";
