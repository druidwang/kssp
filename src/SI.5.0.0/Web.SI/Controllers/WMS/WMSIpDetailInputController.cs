...
{
    public class WMSIpDetailInputController : WebAppBaseController
    {
        public WMSIpDetailInputController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SI_WMS_IpDetailInput e where e.Status = @p0 and e.CreateTime > @p1 and e.CreateTime < @p2  ";
