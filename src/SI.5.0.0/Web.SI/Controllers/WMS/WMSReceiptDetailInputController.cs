...
{
    public class WMSReceiptDetailInputController : WebAppBaseController
    {
        public WMSReceiptDetailInputController()
        {
        ...
        public ActionResult Index(SearchModel searchModel)
        {
            ...
            string sql = @"select top " + MaxRowSize +
                @" e.* from SI_WMS_ReceiptDetailInput e where e.Status = @p0 and e.CreateTime > @p1 and e.CreateTime < @p2  ";
