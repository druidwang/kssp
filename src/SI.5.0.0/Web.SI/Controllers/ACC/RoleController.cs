...
namespace com.Sconit.Web.Controllers.ACC
{
    ...
    public class RoleController : AuthorizationBaseController
    {
        ...
        /// </summary>
        private static string selectUsersNotInRole = @"select u from User as u where u.Id not in (select ur.User.Id from UserRole as ur where ur.Role.Id = ?)";
